...
- **Dialect-aware generation** — set a per-mode "Dialect / variant" (Settings → Study, e.g. *Latin American Spanish*) and every generator follows it: new cards' pronunciation lines, memory-hook sound-alikes, tapped-word phonetics, and question phrasing (no more Castilian "ga-THE-la" when you're learning for Latin America)
