...
- **Memory hooks everywhere** — the same "help me remember" engine (sound-alikes, associations, rationalizations) is available on graded study cards, on any card in the deck browser ("Help me learn this"), and on any word you tap mid-question
...
- **🧠 Help me learn this** — expand any card and ask Ebi for a memory hook (mnemonics, associations, or the reasoning behind the answer); "Another hook" stacks different angles
