              ...
              <div style={{ borderTop: '1px solid rgba(110,118,129,0.2)', paddingTop: 10, marginTop: 6 }}>
                ...
                <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                  ...
                  <button onClick={onCancelCard} disabled={cardSaving}
                    style={{ background: 'transparent', color: C.dim, border: '1px solid rgba(110,118,129,0.25)', borderRadius: 5, padding: '6px 12px', fontSize: 12, cursor: 'pointer', fontFamily: 'inherit' }}>{t('cancel')}</button>
