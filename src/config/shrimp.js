...
export const SHRIMP = [
  ...
  { name: 'knife', file: '9646-shrimp-killer.png', keywords: ['knife', 'cut', 'cutting', 'slice', 'sliced', 'slicing', 'chop', 'chopping', 'dice', 'mince', 'stab', 'stabbing', 'dagger', 'blade', 'carve', 'peel', 'kill', 'killer', 'murder', 'slay', 'assassin', 'deadly', 'lethal', 'cuchillo', 'cortar', 'picar', 'rebanar', 'apuñalar'] },
